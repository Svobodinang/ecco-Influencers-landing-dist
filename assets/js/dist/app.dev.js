    ...
    8188: function _(e, t, r) {
      ...
      var f = function () {
        function e(t) {
          !function (e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
          }(this, e), g(this, "isMouseTracking", !1), g(this, "cursor", void 0), g(this, "parentElement", void 0), g(this, "document", {
            w: 0,
            h: 0
          }), g(this, "fps", 3), g(this, "counter", 1), this.parentElement = document.querySelector(t), this.getDocumentSize(), this.cursor = new m(this.parentElement);
        }
            ...
            [].push(i().create({
              ...
              onUpdate: function onUpdate(t) {
                ...
                if (e.phase = s > 0 ? r ? o > .8 ? 4 : o > .65 ? 3 : 1 : o < .05 ? 0 : 3 : r ? o > .65 ? 3 : o < .4 ? 0 : 1 : 0, e.phase > 0 && e.phase < 4) {
                  var n = (o - .45) / (.8 - .45);
                  n < .05 && (n = 0), e.mainPart1.style.setProperty("--parallax-progress", n);
                }

                i !== e.phase && e.mainPageUpdate();
              }
            }));
          }
        }, {
