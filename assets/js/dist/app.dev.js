...
(function () {
  ...
  var e,
      t = {
    8188: function _(e, t, r) {
      r(9823), r(9606), r(7472), r(6139), r(7680), r(3085), r(1954);
      var o = r(9667),
          s = r(7734),
          n = r.n(s),
          i = r(804),
      ...
      var m = function () {
        ...
        return t = e, (r = [{
          ...
          value: function value() {
            ...
            this.parentElement.onmousemove = function (t) {
              e.x = t.pageX, e.y = t.pageY > window.innerHeight ? t.pageY - window.innerHeight : t.pageY;
            };
          }
        }]) && d(t.prototype, r), Object.defineProperty(t, "prototype", {
          writable: !1
        }), e;
      }();
      ...
      var u = function () {
        function e(t) {
          !function (e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
          }(this, e), f(this, "isMouseTracking", !1), f(this, "cursor", void 0), f(this, "parentElement", void 0), f(this, "document", {
            w: 0,
            h: 0
          }), f(this, "fps", 3), f(this, "counter", 1), this.parentElement = document.querySelector(t), this.getDocumentSize(), this.cursor = new m(this.parentElement);
        }
        ...
        return t = e, (r = [{
          key: "mouseTracking",
          value: function value() {
            this.parentElement ? (this.counter += 1, this.counter === this.fps && (this.counter = 1, this.setCssParallaxValues()), this.isMouseTracking && requestAnimationFrame(this.mouseTracking.bind(this))) : console.log("parentElement not exist");
          }
        }, {
          key: "startMouseTracking",
          value: function value() {
            this.isMouseTracking = !0, this.mouseTracking();
          }
        }, {
          key: "stopMouseTracking",
          value: function value() {
            this.isMouseTracking = !1;
          }
        }, {
          key: "getDocumentSize",
          value: function value() {
            this.document.w = this.parentElement.offsetWidth, this.document.h = this.parentElement.offsetHeight;
          }
        }, {
          key: "setCssParallaxValues",
          value: function value() {
            var e = this.cursor.x / this.document.w,
                t = this.cursor.y / this.document.h;
            e > 1 && (e = 1), e < 0 && (e = 0), t > 1 && (t = 1), t < 0 && (t = 0), t -= .5, this.parentElement.style.cssText = "\n            --parallax-progress-x: ".concat(e, ";\n            --parallax-progress-y: ").concat(t, "\n        ");
          }
        }, {
          key: "windowResize",
          value: function value() {
      ...
      var b = function b() {
        ...
        function e() {
          ...
          }, 3e3), b() ? this.initSwipers() : (this.mouseMovement = new u("#mainPageBack"), this.addImgHoverListener(), this.mouseMovement.startMouseTracking()), this.addMainScrollTrigger(), this.addCharactersLeadTrigger(), this.addInviewByScroll(), this.addNavigation();
        }

        var t, r;
        return t = e, (r = [{
          key: "addMainScrollTrigger",
          value: function value() {
            var e = this;
            [].push(n().create({
              trigger: this.mainPart2,
              start: "top bottom",
              end: "bottom 10%",
              onLeave: function onLeave() {
                e.mouseMovement && e.mouseMovement.stopMouseTracking(), e.phase = 5, e.mainPageUpdate();
              },
              onEnterBack: function onEnterBack() {
                e.mouseMovement && e.mouseMovement.startMouseTracking();
              },
              onUpdate: function onUpdate(t) {
                ...
                if (e.phase = s > 0 ? r ? o > .8 ? 4 : o > .65 ? 3 : 1 : o < .05 ? 0 : 3 : r ? o > .65 ? 3 : o < .4 ? 0 : 1 : 0, e.phase > 0 && e.phase < 4) {
                  var i = (o - .45) / (.8 - .45);
                  i < .05 && (i = 0), e.mainPart1.style.setProperty("--parallax-progress", i);
                }

                n !== e.phase && e.mainPageUpdate();
              }
            }));
          }
        }, {
          ...
          value: function value() {
            if (3 !== this.phase) {
              if (4 === this.phase) return this.mainPart1.classList.add("video-entered"), this.mainPart2.classList.add("video-entered"), void Array.from(document.querySelectorAll(".toggle-main-video")).forEach(function (e) {
                e.classList.add("entered");
              });
              if (5 === this.phase) return this.mainPart1.classList.add("video-leave"), void Array.from(document.querySelectorAll(".toggle-main-video-leave")).forEach(function (e) {
                e.classList.remove("entered");
              });
              this.mainPart1.classList.remove("video-entered"), this.mainPart2.classList.remove("video-entered"), this.mainPart1.classList.remove("video-leave"), Array.from(document.querySelectorAll(".toggle-main-video-leave")).forEach(function (e) {
                e.classList.add("entered");
              }), Array.from(document.querySelectorAll(".toggle-main-video")).forEach(function (e) {
                e.classList.remove("entered");
              });
              var e = null;
              1 === this.phase ? (e = this.mainPart1.offsetHeight - 80, this.mainPart1.classList.remove("entered"), this.mainPart2.classList.add("entered")) : (e = 0, this.mainPart1.classList.add("entered"), this.mainPart2.classList.remove("entered")), o.ZP.to(window, {
                duration: .75,
                scrollTo: e
              });
          ...
          value: function value() {
            var e = this;
            Array.from(document.querySelectorAll(".main-page-back__img")).forEach(function (t) {
              t.addEventListener("mouseover", function () {
                e.main.style.setProperty("--theme", "var(--theme-".concat(t.getAttribute("heroId"), ")"));
              });
            });
          }
        }, {
          key: "addCharactersLeadTrigger",
          value: function value() {
            var e = this,
                t = Array.from(document.querySelectorAll(".section-lead")),
                r = b() ? 55 : 86;
            t.forEach(function (t, s) {
              e["tlLead".concat(s)] = o.ZP.timeline({
                scrollTrigger: {
                  trigger: t,
                  start: "top ".concat(r),
                  end: "bottom bottom",
          ...
          value: function value(e) {
            this.hasScrolling || e.querySelector(".section-lead__title").classList.toggle("entered");
          }
        }, {
          key: "initSwipers",
          value: function value() {
            var e = this;
            this.swiperNav = new c.ZP(".swiper-nav", {
              modules: [c.W_],
              navigation: {
              ...
              e["swiperProducts".concat(r)] = new c.ZP(o, {
                modules: [c.W_],
                navigation: {
                  nextEl: o.querySelector(".slide-next"),
                  prevEl: o.querySelector(".slide-prev")
                }
              });
            }), this.swiperMainDecor = new c.ZP(".swiper-main-decor", {
              modules: [c.pt],
              autoplay: {
                delay: 2e3
              },
          ...
          value: function value() {
            Array.from(document.querySelectorAll(".inview")).forEach(function (e) {
              n().create({
                trigger: e,
                start: "top 90%",
                end: "bottom top",
                onToggle: function onToggle(t) {
                  t.isActive && e.classList.add("entered");
                },
                onUpdate: function onUpdate(t) {
                  var r = t.progress;
                  e.hasAttribute("parallax") && e.style.setProperty("--parallax-progress", r);
                }
              });
            });
          }
          ...
          value: function value() {
            var e = this;
            Array.from(document.querySelectorAll(".nav__item")).forEach(function (t) {
              t.addEventListener("click", function () {
                e.hasScrolling = !0, o.ZP.to(window, {
                  duration: 1,
                  scrollTo: {
                    y: ".content__section--".concat(t.getAttribute("heroId")),
                    offsetY: 70
                  },
      ...
      setTimeout(function () {
        ...
        e.classList.add("hide"), setTimeout(function () {
          e.remove(), Array.from(document.querySelectorAll(".main-inview")).forEach(function (e) {
            e.classList.add("entered");
          });
        }, 350);
      }, 2500), new y() && console.log("animate started");
    }
  },
      r = {};
  ...
  o.m = t, e = [], o.O = function (t, r, s, n) {
    if (!r) {
      var i = 1 / 0;

      for (d = 0; d < e.length; d++) {
        for (var _e$d = _slicedToArray(e[d], 3), r = _e$d[0], s = _e$d[1], n = _e$d[2], a = !0, c = 0; c < r.length; c++) {
          (!1 & n || i >= n) && Object.keys(o.O).every(function (e) {
            return o.O[e](r[c]);
          }) ? r.splice(c--, 1) : (a = !1, n < i && (i = n));
        }
    ...
    var t = function t(_t, r) {
      ...
      for (_t && _t(r); p < i.length; p++) {
        n = i[p], o.o(e, n) && e[n] && e[n][0](), e[n] = 0;
      }
